...
if SERVER then
    ...
    hook.Add("player_connect", "access_whitelist1", function( data, steamID64 )
        for k, v in pairs( data ) do
            if not allowed[data.networkid] then game.KickID( data.networkid, "Тебя нет списке разработчиков. Нет доступа. \n\nЗалетай к нам в дискорд и ожидай выхода Политопии :) \nhttps://discord.gg/7vES6nzqYC" ) end
        end
    end)
