...
netstream.Hook( 'entlib.createJobMenu', function( c, a ) 
	...
	if ( !timer.Exists( 'entlib.checkTimer' ) ) then
			...
			for id, job in pairs( RPExtraTeams ) do
				...
				function lst:DoDoubleClick( lineID, line )
					...
					function() 
						...
						timer.Create( 'entlib.checkTimer', 5, 1, function()
							c:polyMsg( 60, 'В жизни случаюсь перемены, рано или поздно, хочешь ты того, или нет...' )
						end)
